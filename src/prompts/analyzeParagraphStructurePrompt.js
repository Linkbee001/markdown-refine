...
1.  **主要目标**：确保所有内容都被包含在具有 \`class="paragraph-component"\` 的块级元素（通常是 \`<div>\`）中。每个这样的元素代表一个逻辑段落或内容块。
2.  **保留结构**：尽量保留原始的HTML标签（如 \`<h1>\`-\`<h6>\`, \`<ul>\`, \`<ol>\`, \`<pre>\`, \`<blockquote>\`, \`<img>\` 等）。
3.  **段落包裹**：
    *   如果元素没有被块级元素包裹，应该用 \`<div class="paragraph-component">\` 包裹起来。
    *   独立的块级元素（如标题 \`<h1>\`, 列表 \`<ul>\`, 代码块 \`<pre>\`, 引用 \`<blockquote>\`）应该被包裹到 \`<div class="paragraph-component">\` 中。例如
        \`\`\`html
        <div>
            <h1>标题1</h1>
        </div>
        ...
        \`\`\`
    *   对于连续没有被包裹的元素，应该用一个 \`<div class="paragraph-component">\` 包裹起来，例如
        \`\`\`html
        <h1>标题1</h1>
        <h2>标题2</h2>
        \`\`\`
        应该优化成
        \`\`\`html
        <div class="paragraph-component" id="component-1">
...
5.  **现有类名处理**:
    ...
    *  针对已经存在的段落包裹元素（通常是 \`<div>\` 或 \`<div>\`）, 保留已经存在的类名，将 \`paragraph-component\` 添加到改元素的类列表中。
6.  **文本元素的处理**:
    *   文本元素是指那些没有被标签包裹的文本内容，例如：
        \`\`\`html
        <h1>标题</h1>
        一些文本。
        <div class="date-component" id="date1">2024.01.01</div>
        <ul><li>列表项</li></ul>
        END
        \`\`\`
        其中“一些文本。”就是文本内容元素
...
<img src="..." alt="...">
<img src="..." alt="...">
<div class="ending-component">END</div>
\`\`\`
期望输出:
\`\`\`html
<div class="paragraph-component" id="component-1">
...
<div class="paragraph-component" id="component-4">
    <span id="component-9" class="text-component">
        一些文本1。<br/>
        一些文本2。
    </span>
</div>
<div class="date-component paragraph-component" id="date1">2024.01.01</div>
<div class="paragraph-component" id="component-5">
...
<div class="paragraph-component ending-component" id="component-8">
    END
</div>
\`\`\`
`; 